          ...
          <span style={{ color: 'rgb(127, 127, 127)' }}>
            <strong>
              <span data-custom-class='subtitle'>
                Last updated <bdt className='question'>August 02, 2020</bdt>
              </span>
            </strong>
          </span>
        </p>
        ...
        <p style={{ fontSize: 15 }}>
          <span style={{ color: 'rgb(89, 89, 89)' }}>
            <span data-custom-class='body_text'>
              ...
              <bdt className='question'>Artsy Crafty Jassy LLC</bdt>
              ...
              <bdt className='question'>artsycraftyjassy@gmail.com</bdt>.
            </span>
          </span>
        </p>
        <p style={{ fontSize: 15 }}>
          <span style={{ color: 'rgb(89, 89, 89)' }}>
            <span data-custom-class='body_text'>
              ...
              <bdt className='statement-end-if-in-editor' />
              <bdt className='block-component' />
              <bdt className='block-component' /> and more generally, use any of
              our services (the "<strong>Services</strong>", which include the{' '}
              <span style={{ color: 'rgb(89, 89, 89)' }}>
                <span data-custom-class='body_text'>
                  <bdt className='block-component' />
                  Website
              ...
              <span style={{ color: 'rgb(89, 89, 89)' }}>
                <span data-custom-class='body_text'>
                  <span style={{ color: 'rgb(89, 89, 89)' }}>
                    <span data-custom-class='body_text'>
                      <bdt className='forloop-component' />{' '}
                      <bdt className='question'>Cashapp</bdt>
                      <span style={{ color: 'rgb(89, 89, 89)' }}>
                        <span data-custom-class='body_text'>
                          <span style={{ color: 'rgb(89, 89, 89)' }}>
                            <span data-custom-class='body_text'>
                              <bdt className='forloop-component' /> and{' '}
                              <span style={{ color: 'rgb(89, 89, 89)' }}>
                                <span data-custom-class='body_text'>
                                  <span style={{ color: 'rgb(89, 89, 89)' }}>
                                    <span data-custom-class='body_text'>
                      ...
                      <div>
                          ...
                          <span style={{ fontSize: 15 }}>
                            <span style={{ color: 'rgb(89, 89, 89)' }}>
                              <span data-custom-class='body_text'>
                                ...
                                longer than <bdt className='block-component' />
                                <bdt className='question'>1 year</bdt>
                                <bdt className='statement-end-if-in-editor' />.
                              </span>
                            </span>
                          </span>
                          ...
                          <span style={{ fontSize: 15 }}>
                            <span style={{ color: 'rgb(89, 89, 89)' }}>
                              <span data-custom-class='body_text'>
                                ...
                                protection supervisory authority. You can find
                        ...
                        <div>
                          ...
                          >
                            <span data-custom-class='body_text'>
                              ...
                              certain rights and obligations apply regarding
                        ...
                        <div>
                          ...
                          >
                            <span data-custom-class='body_text'>
                              <bdt className='question'>
                                Artsy Crafty Jassy LLC
                              </bdt>{' '}
                              has not disclosed or sold any personal information
                          ...
                          <span style={{ color: 'rgb(0, 0, 0)' }}>
                            <span style={{ fontSize: 15 }}>
                              <span data-custom-class='body_text'>
                                ...
                                that we can match it with the information you
                                have previously provided us. For instance,
                                depending on the type of request you submit, we
                                may ask you to provide certain information so
                                that we can match the information you provide
                                with the information we already have on file, or
                          ...
                          <span style={{ color: 'rgb(0, 0, 0)' }}>
                            <span style={{ fontSize: 15 }}>
                              <span data-custom-class='body_text'>
                                ...
                                verification. If, however, if we cannot verify
                                ...
                                of verifying your identity, and for security or
                            ...
                            <p style={{ fontSize: 15 }}>
                              ...
                              >
                                <span data-custom-class='body_text'>
                                  ...
                                  Upon receiving a request to opt-out, we will
                                  act upon the request as soon as feasibly
                                  possible, but no later than 15 days from the
                        ...
                        <p style={{ fontSize: 15 }}>
                          <span style={{ color: 'rgb(89, 89, 89)' }}>
                            ...
                            <span style={{ fontSize: 15 }}>
                              <em>
                                <span data-custom-class='body_text'>
                                  Yes, we will update this notice as necessary
                        ...
                        <div>
                          <span data-custom-class='body_text'>
                            <span style={{ color: 'rgb(89, 89, 89)' }}>
                              <span style={{ fontSize: 15 }}>
                                <bdt className='question'>550 Grand St</bdt>
                                <bdt className='block-component' />
                              </span>
                            </span>
                          </span>
                          ...
                          <span data-custom-class='body_text'>
                            <span style={{ color: 'rgb(89, 89, 89)' }}>
                              <span style={{ fontSize: 15 }}>
                                ...
                                <bdt className='block-component' />
                                <bdt className='block-component' />{' '}
                                <bdt className='question'>10002</bdt>
                                <bdt className='statement-end-if-in-editor' />
                              </span>
                            </span>
                          </span>
                        ...
                        <div>
                          <span data-custom-class='body_text'>
                            ...
                            <span style={{ color: 'rgb(48, 48, 241)' }}>
                              <span data-custom-class='body_text'>
                                <span style={{ fontSize: 15 }}>
                                  <a
                                    data-custom-class='link'
                                    href='https://app.termly.io/notify/3eabf57c-5157-46fd-9d30-8e72b987d057'
                                    rel='noopener noreferrer'
                                    target='_blank'
                                  >
                                    here
                            ...
                            <bdt className='block-component' />. We will respond
